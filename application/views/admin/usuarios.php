...
<head>
    ...
    <title>Alumnos</title><!--[if IE]>
<script type="text/javascript" src="js/excanvas.js"></script>
<![endif]-->
</head>

<body class="layout980" id="users-page">
    <div id="page-wrapper" class="width">
        ...
        <div id="header">
            ...
            <div class="user-area fr">
                ...
                <ul id="nav">
                <li class="users current"><a href="<?=site_url("admin"); ?>">Alumnos</a></li>
        ...
        <div id="page">
            ...
            <div class="container_12">
                <div class="grid_12">
                    <a href="#add-form" id="add" class="button medium blue" style="margin: 0 0 10px 0;" name="add">Nuevo Alumno</a>
                </div><br class="cl" />
                <!-- TABLES -->

                <div class="grid_12">
                    <div class="box-header">
                        <ul id="tables-tabs" class="tabs fr"></ul>Alumnos
                    </div><!-- TABLES - TAB 1 -->
                    ...
                    <div id="table-tab1" class="box table tab-content">
                        <table cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <? $deleteController =  site_url("usuarios/delete/" . $item->id ); ?>
                                <? $editController =  site_url( "usuarios/edit/" . $item->id ); ?>
                ...
                <div id="add-form" class="grid_7">
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                                <label>Matr&iacute;cula:</label> <input type="text" name="matricula" />
                            </div>
                            <div class="row">
