		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div class="block">
				...
				<div class="block_head">
					...
					<ul>
						<li>
						<a href="<?= site_url("CategoriasController/mostrarFormularioCategoria/0"); ?>"> Agregar Categor&iacute;a
						</a>
						</li>
					</ul>
				</div>		<!-- .block_head ends -->
				...
				<div class="block_content">
					...
					<? foreach($items as $item): ?>
                                ...
                                <? $editController =  site_url( "CategoriasController/mostrarFormularioCategoria/" . $item->id ); ?>
