...
<head>
	...
	<title>EMISOFT - Modificar Categor&iacute;a</title>
...
<body>
	...
	<div id="hld">
		...
		<div class="wrapper">		<!-- wrapper begins -->
			...
			<div>
			<div class="block" style="width: 700px" id="box">
				...
				<div class="block_content" >
					<form action="<?= site_url($action); ?>" method="post">
						...
						<textarea class="text" name="descripcion"  ><?= $descripcion; ?></textarea>
						</p>
						<p>
						<label for="departamento">Departamento:</label>
						<?= form_dropdown('departamento_id', $items, $departamento_id, 'class="styled"' );?>
						</p>						
						<input type="submit" class="submit small" value="Guardar" />
