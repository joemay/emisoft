DateInput = (function ($) {
    ...
    DateInput.DEFAULT_OPTS = {
        month_names: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Augosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"],
        
        short_month_names: ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"],
        
        short_day_names: ["Domingo", "Lunes", "Marte", "Miercoles", "Jueves", "Viernes", "Sabado"],
        start_of_week: 1
    };
    DateInput.prototype = {
        build: function () {
